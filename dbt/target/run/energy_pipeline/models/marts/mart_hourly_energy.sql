    ...
    create or replace table `my-project-1-480817`.`energy_dw_marts`.`mart_hourly_energy`
...
with enriched as (
    select * from `my-project-1-480817`.`energy_dw_intermediate`.`int_enriched_generation_price`
)
