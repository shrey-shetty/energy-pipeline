  ...
  create or replace view `my-project-1-480817`.`energy_dw_intermediate`.`int_enriched_generation_price`
  OPTIONS()
  as -- int_enriched_generation_price.sql
--
...
with base as (
    select * from `my-project-1-480817`.`energy_dw_staging`.`stg_fact_generation_price`
)
select
